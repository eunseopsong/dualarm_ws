...
public:
    /**
     * @brief 생성자: ROS2 노드와 통신 및 파라미터 초기화
     */
...
private:
    ...
    // Joint Data (Arm & Hand)
    Eigen::VectorXd q_l_c_, q_r_c_, q_l_t_, q_r_t_;             // Arm Curr/Target
    Eigen::VectorXd q_l_h_c_, q_r_h_c_, q_l_h_t_, q_r_h_t_;    // Hand Curr/Target
    
    // Force Data
    Eigen::Vector3d f_l_c_, f_r_c_; // Contact Forces
    ...
    // --- Utility Functions ---
    /**
     * @brief Wrist Pose와 Finger Relative Pose를 합성하여 World 좌표를 계산합니다.
     */
